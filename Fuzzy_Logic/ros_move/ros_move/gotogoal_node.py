...
class RobotController(Node):
    ...
    def __init__(self):
        ...
        (self.goal_pose.x, self.goal_pose.y, self.goal_pose.theta) = 1.0, 1.0, 0.0  
        self.goal_count = 0
    ...
    def set_robot_controls(self, pos_tol=0.1, rot_tol=0.1):
        ...
        if self.get_position_error() > pos_tol: # Go to goal
            ...
            ang_vel = self.get_angular_velocity(gain=20.0) # Set robot angular velocity
