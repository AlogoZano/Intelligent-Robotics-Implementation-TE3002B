...
class RobotController(Node):
    ...
    def __init__(self):
        ...
        (self.goal_pose.x, self.goal_pose.y, self.goal_pose.theta) = 1.0, 5.5, 0.0  
        self.goal_count = 0
    ...
    def get_linear_velocity(self, gain=1.0):
        ...
        return gain * self.get_position_error() * self.get_robot_bot_distance()
    ...
    def set_robot_controls(self, pos_tol=0.1, rot_tol=0.1):
        ...
        if self.get_position_error() > pos_tol: # Go to goal
            lin_vel = self.get_linear_velocity(gain=0.1) # Set robot linear velocity
